...
class Flower extends mojs.CustomShape {
  getShape() {
    return '<path d="M -20,-20 C -30,-60 30,-60 20,-20 C 30,-60 -30,-60 -20,-20 M -20,-20 L 0,-50 M 0,-20 L -20,-50 M 20,-20 L 0,-50 M 0,-20 L 20,-50" />';
  }
...
const scaleHeart = new mojs.Shape({
  shape: 'heart',
  fill: 'none',
  stroke: 'white',
  scale: { 0: 3 },
...
const flowerBurst = new mojs.Burst({
  radius: { 0: 300 },
  count: 10,
  children: {
    shape: 'flower',
...
timeline.add(crazy, rect, heart, scaleHeart, flowerBurst);
